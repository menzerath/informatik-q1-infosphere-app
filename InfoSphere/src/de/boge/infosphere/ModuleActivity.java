...
import de.boge.infosphere.module.ViewPagerAdapter;
...
public class ModuleActivity extends SherlockFragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        // Alle Tabs anlegen
        Tab tab = mActionBar.newTab().setText("Grundschule").setTabListener(tabListener);
        mActionBar.addTab(tab);

        tab = mActionBar.newTab().setText("Unterstufe").setTabListener(tabListener);
        mActionBar.addTab(tab);

        tab = mActionBar.newTab().setText("Mittelstufe").setTabListener(tabListener);
        mActionBar.addTab(tab);
        
        tab = mActionBar.newTab().setText("Oberstufe").setTabListener(tabListener);
        mActionBar.addTab(tab);
        // Ende der Tabs
	}
	...
	private class DrawerItemClickListener implements ListView.OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
			NavDrawerHandler.entryClicked(position, getBaseContext(), ModuleActivity.this);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		if (item.getItemId() == android.R.id.home) {
        	...
        	startActivity(new Intent(ModuleActivity.this, SettingsActivity.class));
